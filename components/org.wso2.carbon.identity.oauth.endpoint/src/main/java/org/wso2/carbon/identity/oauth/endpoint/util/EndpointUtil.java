...
public class EndpointUtil {
    ...
    public static String getUserConsentURL(OAuth2Parameters params, String loggedInUser, String sessionDataKey,
        ...
        try {
            ...
            if (isOIDC) {
                consentPage = IdentityUtil.getServerURL(OAuth2Util.OAuthURL.getOIDCConsentPageUrl(), true, true);
            } else {
                consentPage = IdentityUtil.getServerURL(OAuth2Util.OAuthURL.getOAuth2ConsentPageUrl(), true, true);
            }
            if (params != null) {
